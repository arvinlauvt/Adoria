...
const ORDERS_FIELDS = [
  ...
  { name: "Cube Breakdown", types: ["multilineText", "singleLineText"] },
  { name: "Boxes", types: ["number"] },
  { name: "Message Type", types: ["singleSelect"], options: ["Card Message", "Full Letter"] },
  { name: "Message Text", types: ["multilineText", "singleLineText"] },
  ...
  { name: "Order Total (RM)", types: ["number", "currency"] },
  {
    name: "Payment Status",
    types: ["singleSelect"],
